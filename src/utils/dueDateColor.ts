...
// 期限までの残り日数を、黄色（7日前）→橙色（当日）→深紅（超過）と
// 連続的に変化するグラデーション色に変換する。
// 「もうすぐ」と「手遅れ」を明確に区別するため、超過より前の段階は赤系統を避けて
// 黄〜橙にとどめている（優先タスク一覧の色と衝突しないようにする狙いもある）。
...
const SOON_HUE = 48; // 黄色（7日前）
const TODAY_HUE = 26; // 橙色（当日）
